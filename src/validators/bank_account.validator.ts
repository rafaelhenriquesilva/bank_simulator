...
export class BankAccountValidator {
    ...
    static createBankAccountValidator() {
        ...
        let balance = body('balance').isNumeric().notEmpty().withMessage('Balance cannot be empty');
        ...
        let balanceMoreThanZero = body('balance').isNumeric().isFloat({ min: 0 }).withMessage('Balance must be more than zero');
    ...
    static updateUserValidator() {
        ...
        let balance = body('balance').optional().isNumeric().notEmpty().withMessage('Balance cannot be empty');
        ...
        let balanceMoreThanZero = body('balance').optional().isNumeric().isFloat({ min: 0 }).withMessage('Balance must be more than zero');
        return ValidatorUtil.validateFields([
            numberAccountNotEmpty, 
            typeNotEmpty, 
            balance, 
